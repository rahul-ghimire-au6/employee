...
const users=require('../models/employmodel')
...
module.exports={
    ...
    employee_dashboard:async(req,res)=>{
        userid=req.session.userid
        let data = await users.find({_id:userid}).then((response)=>{
            let data1 = response
            console.log(data1)
            res.render('employee_dashboard',{data1})
        })
